...
# 1. data/clean_salary_by_region.csv
# 2. data/clean_salary_by_type.csv 
...
input_file_path_1 <- 'data/clean_salary_by_region.csv'
input_file_path_2 <- 'data/clean_salary_by_type.csv'
...
write.csv(joined_table, file = "data/clean_salary_joined_region_and_type.csv", row.names = FALSE)
