...
**Table 1** above shows there was a statistical difference in salary, all salary types examined, amongst the different regions, with a p-value < 0.05. Next we performed a Tukey's post-hoc test to see which region was responsible for the difference in salary. This is summarized in Table 2 below.
...
```{r echo = FALSE, results = "show"}
df <- read_csv("results/anova_results/school_type_tukey_results.csv") %>% 
  select(-term)
